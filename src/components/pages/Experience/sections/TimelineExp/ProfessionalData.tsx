...
export const professionalData: TimelineItemType[] = [
  {
    ...
    description: [
      "Membangun produk Remittance menggunakan React.js (Vite), Tailwind CSS, dan JavaScript (ES6+) dengan integrasi WalletConnect untuk pertukaran token blockchain, serta dashboard admin untuk monitoring user, transaksi, dan volume token — diselesaikan dalam 1 bulan, berkolaborasi dengan backend developer via RESTful API.",
      "Mengembangkan sistem Webmail internal perusahaan secara end-to-end menggunakan Next.js, JavaScript, dan Tailwind CSS sebagai sole frontend developer — diselesaikan dalam 1 bulan, berkolaborasi dengan backend developer via RESTful API.",
