...
export const Footer = () => {
  return (
    <footer className="py-8 md:px-12 lg:px-48 xl:px-48 p-6 flex flex-col md:gap-6 gap-6 border-t border-slate-200 dark:border-slate-800 transition-colors duration-300 dark:bg-slate-900">
